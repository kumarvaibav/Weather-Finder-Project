...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=a714fb79d3a30cb30d8973e58434495d')
...
function DefaultScreen(){
    document.getElementById("cityInput").defaultValue = "Shamli";
    GetInfo();
}
